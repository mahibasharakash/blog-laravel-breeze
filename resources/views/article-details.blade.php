...
@section('content')
    ...
    <main class="w-full px-4 py-20 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div class="w-full mx-auto max-w-7xl">
            ...
            <a class="inline-flex items-center justify-center gap-2 px-3 py-1 mb-6 text-lg font-medium transition rounded-full ring-1 ring-inset text-zinc-400 ring-white/10 hover:bg-white/5 hover:text-white" href="{{route('home')}}">
                    ...
                    <div>
                        ...
                        <div class="flex flex-row flex-wrap items-center justify-center gap-4 my-6 text-center divide-x divide-zinc-700">
                            ...
                            <div class="flex items-center gap-2">
                                <img class="w-8 h-8 p-0.5 rounded-full ring-1 ring-emerald-500" src="https://avatars.githubusercontent.com/u/61485238?v=4" alt="Al Nahian" />
                            ...
                            {{-- Category Pill --}}
                            <div class="pl-4">
                                <a class="inline-flex gap-0.5 justify-center overflow-hidden text-sm sm:text-base font-medium transition rounded-full py-1 px-3 bg-emerald-400/10 text-emerald-400 ring-1 ring-inset ring-emerald-400/20 hover:bg-emerald-400/10 hover:text-emerald-300 hover:ring-emerald-300" href="{{route('article.category', $post->category->slug)}}">
                                    {{ $post->category->name }}
                                </a>
                            </div>
                        ...
                        <div class="my-8">
                            <hr class="h-px border-0 bg-zinc-700">
                        </div>
