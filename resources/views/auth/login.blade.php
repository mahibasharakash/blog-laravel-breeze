<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <x-primary-button class="me-3"> {{ __('Log in') }} </x-primary-button>

            @if (Route::has('password.request'))
                <a class="underline text-sm text-white rounded-md" href="{{ route('password.request') }}">
        ...
        <div class="flex items-center justify-center mt-4">
            <a class="underline text-sm text-white rounded-md" href="{{ route('register') }}">
